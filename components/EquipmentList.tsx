...
import { Plus, Trash2, Backpack, GripVertical } from 'lucide-react';
...
const SortableItem = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-1 mb-1 mt-1 pl-5">
        <select 
      ...
      <TextareaAutosize 
        className="w-full bg-transparent resize-none text-[10px] text-slate-600 focus:outline-none placeholder-slate-300 mt-1 pl-5"
        minRows={1}
...
export const EquipmentList = ({ 
  ...
  onRemove: (id: string) => void; 
  onUpdate: (id: string, field: keyof EquipmentEntry, val: any) => void;
  onReorder?: (items: EquipmentEntry[]) => void;
  className?: string;
